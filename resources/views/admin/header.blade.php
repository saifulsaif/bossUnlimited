                ...
                <div class="mobile-menu">
                    <nav id="dropdown">
                        <ul class="mobile-menu-nav">
                            ...
                            <li><a data-toggle="collapse" data-target="#demoevent" href="#">Photo</a>
                            ...
                            <li><a  href="{{route('admin.promotion')}}"><i class="notika-icon notika-windows"></i> Promotion</a></li>
                            <li><a href="{{route('setting')}}"><i class="notika-icon notika-support"></i> Setting</a></li>
                            <li><a href="{{route('movie')}}"><i class="notika-icon notika-support"></i> Movie</a></li>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                    ...
                    <li class="active"><a data-toggle="tab" href="#mailbox"><i class="notika-icon notika-mail"></i> Photo</a>
                    </li>
