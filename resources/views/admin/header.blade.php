                ...
                <div class="mobile-menu">
                    <nav id="dropdown">
                        <ul class="mobile-menu-nav">
                          ...
                          <li><a data-toggle="tab" href="#Interface"><i class="notika-icon notika-edit"></i> Photo</a></li>
                          <li><a  href="{{route('admin.promotion')}}"><i class="notika-icon notika-windows"></i> Promotion</a></li>
                          <li><a data-toggle="tab" href="#Users"><i class="notika-icon notika-edit"></i> Users</a></li>
